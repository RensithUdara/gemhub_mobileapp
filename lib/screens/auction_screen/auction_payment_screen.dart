...
class _AuctionPaymentScreenState extends State<AuctionPaymentScreen> {
  ...
  Future<void> _handlePaymentSubmission() async {
    ...
    try {
      ...
      DateTime paymentDate = DateTime.now(); // Current date as payment date
      DateTime deliveryDate = paymentDate.add(
          const Duration(days: 5)); // Delivery date = payment date + 5 days

      Map<String, dynamic> orderData = {
        'userId': currentUser.uid,
        'auctionId': widget.auctionId,
        'orderDate': paymentDate.toIso8601String(), // Store as ISO string
        'deliveryDate': deliveryDate.toIso8601String(), // Store as ISO string
